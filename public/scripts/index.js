        ...
        this.draw = function (_this) {
            return function () {
                ...
                if(_this.message_side === 'left'){
                   $message.find('.avatar').append('<h1 class="letter"><img src="images/IBM_Watson_avatar.png" width="68%"/></h1>');
                }else{
                   $message.find('.avatar').append('<h1 class="letter"><img src="images/user.png" width="70%"/></h1>');
                }
...
function home(){
	document.getElementById('conteudo').innerHTML="Aqui você encontra como informações sobre o seu ThinkPad para utilizar no ambiente de trabalho além de respostas das dúvidas mais comuns do seu primeiro dia. Basta Peguntar ao Noobot ou ligue para o suporte pelo ramal 2500 ou leve seu ThinkPad até o ThinkDesk no segundo andar do edifício Tutóia.";
}

function about(){
	document.getElementById('conteudo').innerHTML="ThinkPad é uma linha de computadores portáteis, originalmente projetado por Richard Sapper, fabricado e vendido pela IBM e posteriormente pela Lenovo. Este chatbot foi desenvolvido por Pedro Micheletto Palhares usando o serviço Watson Conversation da IBM";
}
